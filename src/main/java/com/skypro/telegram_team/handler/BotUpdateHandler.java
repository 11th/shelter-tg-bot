...
public class BotUpdateHandler {
    private final BotMessageHandler messageListener;
    private final BotCallbackHandler callbackListener;

    public BotUpdateHandler(BotMessageHandler messageListener,
                            BotCallbackHandler callbackListener) {
